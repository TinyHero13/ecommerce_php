      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="single-product">
            ...
            <img src="../imagens/produto/<?= $row['img']?>.jpg" alt="" with="200px" height="300px">       
               <div class="p_icon">
                <a href="#">
                  <i class="ti-eye"></i>
                </a>
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                    ...
                    <h4><td><?php echo $row["nome"]; ?></td></h4>
              </a>
              <div class="mt-3">
                <span class="mr-4"><td>R$<?php echo $row["preco"];     
                   ?></td></span>
              </div>
            </div>
          </div>
