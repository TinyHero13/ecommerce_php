    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="card-text">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span>3422-4324(21)</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <i class="fas fa-map-marker ml-3"></i>
                                    <span>.Rio de Janeiro, Nova Iguaçu</span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <i class="fas fa-envelope-open ml-3"></i>
                                    <span>arsenatec@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col text-center">
                <img src="../imagens/logo.png" alt="ArsenaTec" class="mb-3">
                <br class="clearfix">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col text-left">
                <a href="http://mihanmedia.ir" class="f-light text-dark">Feito por:</a>
                <a href="http://mihanmedia.ir"  class="f-light text-dark">Guilherme de Souza e Yasmim Abrahão </a>
            </div>
        </div>
    </div>
</section>