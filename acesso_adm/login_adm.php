...
?>
<p> Erro: 4c3ss0 n3g#d$. </P>
<?php
endif;
unset($_SESSION['Não_autenticado_adm']);
?>

<input type="password" name="chave" required="required" placeholder="Chave de acesso" />
<input type="text" name="adm" required="required" placeholder="Administrador" />
<input type="password" name="senha_adm" required="required" placeholder="Passe de acesso" id="pass" /><br>
